...
- `../bascule-rapport-archives/correctifs-v11-1.jsx` (appliqué le 19 septembre 2026) : correctifs de texte de la relecture de la V11 (typographie, traits d'union des titres de graphiques, formes inclusives, points finaux des lignes « Champ », métadonnées du PDF). Il propose une simulation puis une application, écrit un rapport à côté du document et saute toute règle dont le nombre d'occurrences diffère de celui compté sur l'IDML du 15 septembre 2026.
...
Les scripts à usage unique déjà appliqués et ceux qui n'ont pas été retenus sont dans `../bascule-rapport-archives/`, hors du panneau Scripts d'InDesign.
