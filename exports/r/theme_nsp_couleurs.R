...
nsp_coquelicot <- c("#FFF2F1", "#FFDDDB", "#FFC7C4", "#FFB1AD", "#FF9996", "#FF7F7E", "#F36D6D", "#E45C5F", "#D44E52", "#C24146", "#AF373C", "#9B2E33", "#87272C", "#722225", "#5C1E1F", "#471A1A", "#331515", "#1F1110", "#0B0B0B")
nsp_framboise <- c("#FFF0F8", "#FFDAED", "#FFC2E3", "#FEAAD9", "#F597CD", "#EA85C0", "#DD74B2", "#CF65A5", "#BF5796", "#AE4B88", "#9D407A", "#8B376B", "#782F5C", "#65284E", "#532240", "#401C32", "#2E1724", "#1C1117", "#0B0B0B")
nsp_lavande <- c("#F4F4FF", "#E3E3FF", "#D2D2FF", "#C2C1FF", "#B2B0FF", "#A39EFF", "#958EF5", "#877FE8", "#7A71D8", "#6E64C7", "#6158B4", "#554C9F", "#49428A", "#3E3874", "#322E5E", "#282548", "#1D1C33", "#14141E", "#0B0B0B")
nsp_petrole <- c("#EAF7FF", "#CAECFF", "#ABE0FD", "#92D2F5", "#7AC4EC", "#63B7E2", "#4FA8D5", "#3C9AC8", "#2B8CB9", "#1C7EA9", "#107098", "#096286", "#085574", "#0B4862", "#0E3B50", "#0F2E3D", "#0F222C", "#0E161B", "#0B0B0B")
nsp_canard <- c("#DDFDFC", "#BAF3F2", "#99E8E7", "#77DCDB", "#55CFCF", "#2DC2C2", "#00B4B4", "#00A4A4", "#009595", "#008686", "#007777", "#006868", "#005A5A", "#004C4C", "#003F3F", "#003232", "#062525", "#0B1817", "#0B0B0B")
...
nsp_ambre <- c("#FFF3E8", "#FFE0C3", "#FECC9E", "#F6BB81", "#EDAA67", "#E29A4E", "#D58A37", "#C77C1F", "#B86E02", "#A66200", "#945700", "#824C00", "#714100", "#603700", "#4F2D01", "#3D2407", "#2C1C0B", "#1B130C", "#0B0B0B")
...
nsp_rouge4 <- "#FFDDDB"  # coquelicot 100
