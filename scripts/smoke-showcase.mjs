...
const { genSpectre, paliers, bestCategorical, simulate } = await import("../notebooks/lib/spectre.js");
...
for (const id of Object.keys(SCENARIOS)) {
  ...
  console.log(`${id} : ok (${Object.keys(sp).length} familles, catégoriel ${cat.ordered.length}, carte ${n} paths, simulate ${simulate(t("coquelicot", 600) ?? "#f00", "deutan")})`);
}
